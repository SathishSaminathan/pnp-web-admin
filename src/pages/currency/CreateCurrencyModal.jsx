...
const CreateCurrencyModal = ({ open, onCancel, onSubmit, loading }) => {
    ...
    useEffect(() => {
        if (open) {
            ...
            // Reset country state and fetch page 1
    ...
    const handleCountryChange = (value) => {
        ...
        if (c) form.setFieldValue('countryCode', c.phonecode);
    };
    ...
    return (
        <Modal
            ...
            centered
            width={600}
            title={<span style={{ color: 'var(--text-primary)', fontWeight: 700 }}>Add Currency</span>}
            styles={{
        ...
        >
            <Form form={form} layout="vertical" onFinish={handleFinish}
                ...
                <div className="flex gap-2 justify-end mt-6">
                    ...
                    <Button type="primary" htmlType="submit" loading={loading}>Create Currency</Button>
                </div>
            </Form>
        </Modal>
    );
